...
pdcdisp.o: $(dosdir)/pdcdisp.c $(PDCURSES_HEADERS)
	$(CC) $(CCFLAGS) -o$@ $(dosdir)/pdcdisp.c

pdcgetsc.o: $(dosdir)/pdcgetsc.c $(PDCURSES_HEADERS)
	$(CC) $(CCFLAGS) -o$@ $(dosdir)/pdcgetsc.c

pdckbd.o: $(dosdir)/pdckbd.c $(PDCURSES_HEADERS)
	$(CC) $(CCFLAGS) -o$@ $(dosdir)/pdckbd.c

pdcprint.o: $(dosdir)/pdcprint.c $(PDCURSES_HEADERS)
	$(CC) $(CCFLAGS) -o$@ $(dosdir)/pdcprint.c

pdcscrn.o: $(dosdir)/pdcscrn.c $(PDCURSES_HEADERS)
	$(CC) $(CCFLAGS) -o$@ $(dosdir)/pdcscrn.c

pdcsetsc.o: $(dosdir)/pdcsetsc.c $(PDCURSES_HEADERS)
