...
char * format_addr(struct sockaddr_in6 *address)
{
...
void print_ip_addr(struct sockaddr_in6 *addr, BOOLEAN DoReverseLookup)
{
...
//
int get_pingee(char *ahstr, int dnsreq, struct sockaddr_in6 *address, char **hstr)
{
...
int get_source(char *astr, struct sockaddr_in6 *address)
{
    struct addrinfo hints;
    struct addrinfo *result;
