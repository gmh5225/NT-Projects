...
Abstract:
    ...
    ATL allocates these structures from standard usermode heap.  On AMD64,
    however, heap is protected "no execute" so this isn't an option.

    The code here manages a seperate "heap" of thunk structures that are
