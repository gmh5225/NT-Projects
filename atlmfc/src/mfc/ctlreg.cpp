...
{	
	...
	if (hkeyClassID.Create(HKEY_CLASSES_ROOT, szScratch, NULL, 0, KEY_READ | KEY_WRITE, NULL, NULL) != ERROR_SUCCESS)
	{
		return FALSE;
	}
	if (hkeyProgID.Create(HKEY_CLASSES_ROOT, pszProgID, NULL, 0, KEY_READ | KEY_WRITE, NULL, NULL) !=ERROR_SUCCESS) 
	{
        	return FALSE;
	}
