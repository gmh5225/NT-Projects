...
STATICLINK_OBJS=$D\stdafx.obj $D\nolib.obj \
	...
	$D\mfcmanifest.obj $D\mfcmanifestrtm.obj
...
$D\mfcmanifest.obj: mfcmanifest.c
	cl @<<
/c $(CL_OPT_OUTDIR) $(CPPFLAGS_STATIC_COMMON) mfcmanifest.c
<<

$D\mfcmanifestrtm.obj: mfcmanifest.c
	cl @<<
/c $(CL_OPT_OUTDIR)\mfcmanifestrtm.obj /D_USE_RTM_VERSION $(CPPFLAGS_STATIC_COMMON) mfcmanifest.c
<<
