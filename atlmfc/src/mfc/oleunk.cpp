...
typedef void (*PFNMFCM80ReleaseManagedReferences)(LPUNKNOWN);
...
void AFXAPI _AfxReleaseManagedRefs(LPUNKNOWN lpUnk)
{
	...
	if( NULL != hModule )
	{
		...
		pfnMFCM80ReleaseManagedReferences = 
			reinterpret_cast<PFNMFCM80ReleaseManagedReferences>(GetProcAddress( hModule,
																			"MFCM80ReleaseManagedReferences"));

		if( NULL != pfnMFCM80ReleaseManagedReferences )
		{
			pfnMFCM80ReleaseManagedReferences( lpUnk );
		}
	}
}
